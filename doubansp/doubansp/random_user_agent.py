...
class RandomUserAgentMiddleware(object):
    ...
    def __init__(self, user_agent=''):
        #self.logger = logging.getLogger("doubansp.random_user_agent")
        self.user_agent = user_agent

    def process_request(self, request, spider):#每当request通过时对它进行处理，若返回None将继续scrapy的流程，若是response，将会将该response返回给spider
